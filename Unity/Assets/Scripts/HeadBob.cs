...
public class HeadBob : MonoBehaviour {
	...
	// private vars:
	FirstPersonController2 character;						// a reference to the First Person Character component (on the parent gameobject)
	...
	void Start () {
		...
		character = GetComponent<FirstPersonController2>();
		if (audio == null)
		{
